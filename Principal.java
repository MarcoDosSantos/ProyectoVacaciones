...
public class Principal extends JFrame implements ActionListener{
  ...
  public Principal(){
    ...
    labelBienvenido= new JLabel("Bienvenid@ " + nombre);
    labelBienvenido.setBounds(280,30,300,50);
    labelBienvenido.setFont(new Font("Andale Mono", 1, 32));
    labelBienvenido.setForeground(new Color(255,255,255));
    add(labelBienvenido);

    labelTitle= new JLabel("Datos del trabajador para calcular vacaciones");
  ...
  public void actionPerformed(ActionEvent e){
      ...
      if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") || Departamento.equals("") || Antiguedad.equals("")){
        ...
        if(Departamento.equals("Atención al Cliente")){
          if(Antiguedad.equals("1 año de servicio")){
            textarea1.setText("\n    El trabajador " + nombreTrabajador + " " + AP + " " + AM + "\n    quien labora en el Departamento " + Departamento + " con una antigüedad de " + Antiguedad + "\n    tiene derecho a 6 días de vacaciones.");
          }
    ...
    if(e.getSource()== miElCreador){
      JOptionPane.showMessageDialog(null, "            Desarrollado por Marco Dos Santos\n  linkedin.com/in/marco-david-dos-santos-183b74167\n                       mds14421@gmail.com");
    }
